...
function renderBracket(phase) {
    ...
    if (phase === 'round16' && isGroupsClosed) {
        ...
        const pairings = [
            { m: 1, s: 1, g: 'בית לובאן', r: 0 }, { m: 1, s: 2, g: 'בית עלי', r: 1 },
            { m: 2, s: 1, g: 'בית השב\"ח', r: 0 }, { m: 2, s: 2, g: 'בית תורמוס', r: 1 },
            { m: 3, s: 1, g: 'בית הלוזר', r: 0 }, { m: 3, s: 2, g: 'בית הדורבן', r: 1 },
            { m: 4, s: 1, g: 'בית ששון/ששי\'לה', r: 0 }, { m: 4, s: 2, type: 'bestThird', idx: 0 },
            { m: 5, s: 1, g: 'בית עלי', r: 0 }, { m: 5, s: 2, g: 'בית לובאן', r: 1 },
            { m: 6, s: 1, g: 'בית תורמוס', r: 0 }, { m: 6, s: 2, g: 'בית השב\"ח', r: 1 },
            { m: 7, s: 1, g: 'בית הדורבן', r: 0 }, { m: 7, s: 2, g: 'בית הלוזר', r: 1 },
            { m: 8, s: 1, type: 'bestThird', idx: 1 }, { m: 8, s: 2, g: 'בית ששון/ששי\'לה', r: 1 }
        ];
