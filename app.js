...
function renderBracket(phase) {
    ...
    if (phase === 'round16' && isGroupsClosed) {
        ...
        const pairings = [
            { m: 1, s: 1, g: 'תורמוס', r: 0 }, { m: 1, s: 2, g: 'סינג\'יל', r: 1 },
            { m: 2, s: 1, g: 'שילה', r: 0 }, { m: 2, s: 2, g: 'עלי', r: 1 },
            { m: 3, s: 1, g: 'לובאן', r: 0 }, { m: 3, s: 2, g: 'הדורבן', r: 1 },
            { m: 4, s: 1, g: 'ששון', r: 0 }, { m: 4, s: 2, type: 'bestThird', idx: 0 },
            { m: 5, s: 1, g: 'סינג\'יל', r: 0 }, { m: 5, s: 2, g: 'תורמוס', r: 1 },
            { m: 6, s: 1, g: 'עלי', r: 0 }, { m: 6, s: 2, g: 'שילה', r: 1 },
            { m: 7, s: 1, g: 'הדורבן', r: 0 }, { m: 7, s: 2, g: 'לובאן', r: 1 },
            { m: 8, s: 1, type: 'bestThird', idx: 1 }, { m: 8, s: 2, g: 'ששון', r: 1 }
        ];
